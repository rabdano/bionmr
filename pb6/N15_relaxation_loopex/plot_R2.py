...
body_R2 = R2[resids < 376]
ig_like_resids = resids[resids >= 376]
ig_like_R2 = R2[resids >= 376]
...
# plot
fig, ax = plt.subplots()
ax.plot(body_resids, body_R2, marker="D", ms=3, markeredgecolor="b", markerfacecolor="b",
        linewidth=1.0, color="b", label="tube body")
ax.plot(ig_like_resids, ig_like_R2, marker="D", ms=3, markeredgecolor="g", markerfacecolor="g",
