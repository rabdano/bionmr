...
input_dir = "cor_NH_n___N_DAT_FILES____s___STRIDE___"
output_dir = "cor_NH_n___N_DAT_FILES____s___DILUTE_STRIDE____diluted"
...
for fn in files:
    ...
    nlim = length * ratio
    grid = []
    if remove_first_point!=True: grid.append(0)
    # if (scaling==1.0):
    #     tau = stride
    # else:
    #     tau = 1.0
